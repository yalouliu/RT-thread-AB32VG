...
C_SRCS += \
../rt-thread/components/net/lwip-1.4.1/test/unit/udp/test_udp.c 

OBJS += \
./rt-thread/components/net/lwip-1.4.1/test/unit/udp/test_udp.o 

C_DEPS += \
./rt-thread/components/net/lwip-1.4.1/test/unit/udp/test_udp.d 


# Each subdirectory must supply rules for building sources it contributes
rt-thread/components/net/lwip-1.4.1/test/unit/udp/%.o: ../rt-thread/components/net/lwip-1.4.1/test/unit/udp/%.c
