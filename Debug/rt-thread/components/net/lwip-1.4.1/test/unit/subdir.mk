...
C_SRCS += \
../rt-thread/components/net/lwip-1.4.1/test/unit/lwip_unittests.c 

OBJS += \
./rt-thread/components/net/lwip-1.4.1/test/unit/lwip_unittests.o 

C_DEPS += \
./rt-thread/components/net/lwip-1.4.1/test/unit/lwip_unittests.d 


# Each subdirectory must supply rules for building sources it contributes
rt-thread/components/net/lwip-1.4.1/test/unit/%.o: ../rt-thread/components/net/lwip-1.4.1/test/unit/%.c
