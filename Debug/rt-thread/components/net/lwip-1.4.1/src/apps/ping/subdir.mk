...
C_SRCS += \
../rt-thread/components/net/lwip-1.4.1/src/apps/ping/ping.c 

OBJS += \
./rt-thread/components/net/lwip-1.4.1/src/apps/ping/ping.o 

C_DEPS += \
./rt-thread/components/net/lwip-1.4.1/src/apps/ping/ping.d 


# Each subdirectory must supply rules for building sources it contributes
rt-thread/components/net/lwip-1.4.1/src/apps/ping/%.o: ../rt-thread/components/net/lwip-1.4.1/src/apps/ping/%.c
