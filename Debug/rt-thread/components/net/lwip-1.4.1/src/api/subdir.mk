...
C_SRCS += \
../rt-thread/components/net/lwip-1.4.1/src/api/api_lib.c \
../rt-thread/components/net/lwip-1.4.1/src/api/api_msg.c \
../rt-thread/components/net/lwip-1.4.1/src/api/err.c \
../rt-thread/components/net/lwip-1.4.1/src/api/netbuf.c \
../rt-thread/components/net/lwip-1.4.1/src/api/netdb.c \
../rt-thread/components/net/lwip-1.4.1/src/api/netifapi.c \
../rt-thread/components/net/lwip-1.4.1/src/api/sockets.c \
../rt-thread/components/net/lwip-1.4.1/src/api/tcpip.c 

OBJS += \
./rt-thread/components/net/lwip-1.4.1/src/api/api_lib.o \
./rt-thread/components/net/lwip-1.4.1/src/api/api_msg.o \
./rt-thread/components/net/lwip-1.4.1/src/api/err.o \
./rt-thread/components/net/lwip-1.4.1/src/api/netbuf.o \
./rt-thread/components/net/lwip-1.4.1/src/api/netdb.o \
./rt-thread/components/net/lwip-1.4.1/src/api/netifapi.o \
./rt-thread/components/net/lwip-1.4.1/src/api/sockets.o \
./rt-thread/components/net/lwip-1.4.1/src/api/tcpip.o 

C_DEPS += \
./rt-thread/components/net/lwip-1.4.1/src/api/api_lib.d \
./rt-thread/components/net/lwip-1.4.1/src/api/api_msg.d \
./rt-thread/components/net/lwip-1.4.1/src/api/err.d \
./rt-thread/components/net/lwip-1.4.1/src/api/netbuf.d \
./rt-thread/components/net/lwip-1.4.1/src/api/netdb.d \
./rt-thread/components/net/lwip-1.4.1/src/api/netifapi.d \
./rt-thread/components/net/lwip-1.4.1/src/api/sockets.d \
./rt-thread/components/net/lwip-1.4.1/src/api/tcpip.d 


# Each subdirectory must supply rules for building sources it contributes
rt-thread/components/net/lwip-1.4.1/src/api/%.o: ../rt-thread/components/net/lwip-1.4.1/src/api/%.c
