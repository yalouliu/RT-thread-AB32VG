...
C_SRCS += \
../rt-thread/components/net/lwip-2.1.2/test/sockets/sockets_stresstest.c 

OBJS += \
./rt-thread/components/net/lwip-2.1.2/test/sockets/sockets_stresstest.o 

C_DEPS += \
./rt-thread/components/net/lwip-2.1.2/test/sockets/sockets_stresstest.d 


# Each subdirectory must supply rules for building sources it contributes
rt-thread/components/net/lwip-2.1.2/test/sockets/%.o: ../rt-thread/components/net/lwip-2.1.2/test/sockets/%.c
