...
C_SRCS += \
../rt-thread/components/net/lwip-2.1.2/test/unit/mdns/test_mdns.c 

OBJS += \
./rt-thread/components/net/lwip-2.1.2/test/unit/mdns/test_mdns.o 

C_DEPS += \
./rt-thread/components/net/lwip-2.1.2/test/unit/mdns/test_mdns.d 


# Each subdirectory must supply rules for building sources it contributes
rt-thread/components/net/lwip-2.1.2/test/unit/mdns/%.o: ../rt-thread/components/net/lwip-2.1.2/test/unit/mdns/%.c
