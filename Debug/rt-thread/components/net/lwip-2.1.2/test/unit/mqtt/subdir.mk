...
C_SRCS += \
../rt-thread/components/net/lwip-2.1.2/test/unit/mqtt/test_mqtt.c 

OBJS += \
./rt-thread/components/net/lwip-2.1.2/test/unit/mqtt/test_mqtt.o 

C_DEPS += \
./rt-thread/components/net/lwip-2.1.2/test/unit/mqtt/test_mqtt.d 


# Each subdirectory must supply rules for building sources it contributes
rt-thread/components/net/lwip-2.1.2/test/unit/mqtt/%.o: ../rt-thread/components/net/lwip-2.1.2/test/unit/mqtt/%.c
