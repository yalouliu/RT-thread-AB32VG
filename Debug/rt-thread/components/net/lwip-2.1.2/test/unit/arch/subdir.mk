...
C_SRCS += \
../rt-thread/components/net/lwip-2.1.2/test/unit/arch/sys_arch.c 

OBJS += \
./rt-thread/components/net/lwip-2.1.2/test/unit/arch/sys_arch.o 

C_DEPS += \
./rt-thread/components/net/lwip-2.1.2/test/unit/arch/sys_arch.d 


# Each subdirectory must supply rules for building sources it contributes
rt-thread/components/net/lwip-2.1.2/test/unit/arch/%.o: ../rt-thread/components/net/lwip-2.1.2/test/unit/arch/%.c
