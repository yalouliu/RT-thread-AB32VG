...
C_SRCS += \
../rt-thread/components/net/lwip-2.1.2/test/unit/core/test_def.c \
../rt-thread/components/net/lwip-2.1.2/test/unit/core/test_mem.c \
../rt-thread/components/net/lwip-2.1.2/test/unit/core/test_netif.c \
../rt-thread/components/net/lwip-2.1.2/test/unit/core/test_pbuf.c \
../rt-thread/components/net/lwip-2.1.2/test/unit/core/test_timers.c 

OBJS += \
./rt-thread/components/net/lwip-2.1.2/test/unit/core/test_def.o \
./rt-thread/components/net/lwip-2.1.2/test/unit/core/test_mem.o \
./rt-thread/components/net/lwip-2.1.2/test/unit/core/test_netif.o \
./rt-thread/components/net/lwip-2.1.2/test/unit/core/test_pbuf.o \
./rt-thread/components/net/lwip-2.1.2/test/unit/core/test_timers.o 

C_DEPS += \
./rt-thread/components/net/lwip-2.1.2/test/unit/core/test_def.d \
./rt-thread/components/net/lwip-2.1.2/test/unit/core/test_mem.d \
./rt-thread/components/net/lwip-2.1.2/test/unit/core/test_netif.d \
./rt-thread/components/net/lwip-2.1.2/test/unit/core/test_pbuf.d \
./rt-thread/components/net/lwip-2.1.2/test/unit/core/test_timers.d 


# Each subdirectory must supply rules for building sources it contributes
rt-thread/components/net/lwip-2.1.2/test/unit/core/%.o: ../rt-thread/components/net/lwip-2.1.2/test/unit/core/%.c
