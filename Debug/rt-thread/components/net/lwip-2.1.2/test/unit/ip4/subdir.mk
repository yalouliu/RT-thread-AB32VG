...
C_SRCS += \
../rt-thread/components/net/lwip-2.1.2/test/unit/ip4/test_ip4.c 

OBJS += \
./rt-thread/components/net/lwip-2.1.2/test/unit/ip4/test_ip4.o 

C_DEPS += \
./rt-thread/components/net/lwip-2.1.2/test/unit/ip4/test_ip4.d 


# Each subdirectory must supply rules for building sources it contributes
rt-thread/components/net/lwip-2.1.2/test/unit/ip4/%.o: ../rt-thread/components/net/lwip-2.1.2/test/unit/ip4/%.c
