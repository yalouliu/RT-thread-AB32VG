...
C_SRCS += \
../rt-thread/components/net/lwip-2.1.2/test/unit/api/test_sockets.c 

OBJS += \
./rt-thread/components/net/lwip-2.1.2/test/unit/api/test_sockets.o 

C_DEPS += \
./rt-thread/components/net/lwip-2.1.2/test/unit/api/test_sockets.d 


# Each subdirectory must supply rules for building sources it contributes
rt-thread/components/net/lwip-2.1.2/test/unit/api/%.o: ../rt-thread/components/net/lwip-2.1.2/test/unit/api/%.c
