...
C_SRCS += \
../rt-thread/components/net/lwip-2.1.2/test/unit/tcp/tcp_helper.c \
../rt-thread/components/net/lwip-2.1.2/test/unit/tcp/test_tcp.c \
../rt-thread/components/net/lwip-2.1.2/test/unit/tcp/test_tcp_oos.c 

OBJS += \
./rt-thread/components/net/lwip-2.1.2/test/unit/tcp/tcp_helper.o \
./rt-thread/components/net/lwip-2.1.2/test/unit/tcp/test_tcp.o \
./rt-thread/components/net/lwip-2.1.2/test/unit/tcp/test_tcp_oos.o 

C_DEPS += \
./rt-thread/components/net/lwip-2.1.2/test/unit/tcp/tcp_helper.d \
./rt-thread/components/net/lwip-2.1.2/test/unit/tcp/test_tcp.d \
./rt-thread/components/net/lwip-2.1.2/test/unit/tcp/test_tcp_oos.d 


# Each subdirectory must supply rules for building sources it contributes
rt-thread/components/net/lwip-2.1.2/test/unit/tcp/%.o: ../rt-thread/components/net/lwip-2.1.2/test/unit/tcp/%.c
