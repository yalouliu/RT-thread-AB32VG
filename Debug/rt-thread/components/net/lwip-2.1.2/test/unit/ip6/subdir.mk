...
C_SRCS += \
../rt-thread/components/net/lwip-2.1.2/test/unit/ip6/test_ip6.c 

OBJS += \
./rt-thread/components/net/lwip-2.1.2/test/unit/ip6/test_ip6.o 

C_DEPS += \
./rt-thread/components/net/lwip-2.1.2/test/unit/ip6/test_ip6.d 


# Each subdirectory must supply rules for building sources it contributes
rt-thread/components/net/lwip-2.1.2/test/unit/ip6/%.o: ../rt-thread/components/net/lwip-2.1.2/test/unit/ip6/%.c
