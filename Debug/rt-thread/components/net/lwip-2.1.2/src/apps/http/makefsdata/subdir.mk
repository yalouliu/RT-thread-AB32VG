...
C_SRCS += \
../rt-thread/components/net/lwip-2.1.2/src/apps/http/makefsdata/makefsdata.c 

OBJS += \
./rt-thread/components/net/lwip-2.1.2/src/apps/http/makefsdata/makefsdata.o 

C_DEPS += \
./rt-thread/components/net/lwip-2.1.2/src/apps/http/makefsdata/makefsdata.d 


# Each subdirectory must supply rules for building sources it contributes
rt-thread/components/net/lwip-2.1.2/src/apps/http/makefsdata/%.o: ../rt-thread/components/net/lwip-2.1.2/src/apps/http/makefsdata/%.c
