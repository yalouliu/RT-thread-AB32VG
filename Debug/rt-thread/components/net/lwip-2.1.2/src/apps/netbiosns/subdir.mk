...
C_SRCS += \
../rt-thread/components/net/lwip-2.1.2/src/apps/netbiosns/netbiosns.c 

OBJS += \
./rt-thread/components/net/lwip-2.1.2/src/apps/netbiosns/netbiosns.o 

C_DEPS += \
./rt-thread/components/net/lwip-2.1.2/src/apps/netbiosns/netbiosns.d 


# Each subdirectory must supply rules for building sources it contributes
rt-thread/components/net/lwip-2.1.2/src/apps/netbiosns/%.o: ../rt-thread/components/net/lwip-2.1.2/src/apps/netbiosns/%.c
