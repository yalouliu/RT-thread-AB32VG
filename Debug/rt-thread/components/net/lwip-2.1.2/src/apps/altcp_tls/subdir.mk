...
C_SRCS += \
../rt-thread/components/net/lwip-2.1.2/src/apps/altcp_tls/altcp_tls_mbedtls.c \
../rt-thread/components/net/lwip-2.1.2/src/apps/altcp_tls/altcp_tls_mbedtls_mem.c 

OBJS += \
./rt-thread/components/net/lwip-2.1.2/src/apps/altcp_tls/altcp_tls_mbedtls.o \
./rt-thread/components/net/lwip-2.1.2/src/apps/altcp_tls/altcp_tls_mbedtls_mem.o 

C_DEPS += \
./rt-thread/components/net/lwip-2.1.2/src/apps/altcp_tls/altcp_tls_mbedtls.d \
./rt-thread/components/net/lwip-2.1.2/src/apps/altcp_tls/altcp_tls_mbedtls_mem.d 


# Each subdirectory must supply rules for building sources it contributes
rt-thread/components/net/lwip-2.1.2/src/apps/altcp_tls/%.o: ../rt-thread/components/net/lwip-2.1.2/src/apps/altcp_tls/%.c
