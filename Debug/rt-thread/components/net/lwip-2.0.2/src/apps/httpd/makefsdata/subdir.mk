...
C_SRCS += \
../rt-thread/components/net/lwip-2.0.2/src/apps/httpd/makefsdata/makefsdata.c 

OBJS += \
./rt-thread/components/net/lwip-2.0.2/src/apps/httpd/makefsdata/makefsdata.o 

C_DEPS += \
./rt-thread/components/net/lwip-2.0.2/src/apps/httpd/makefsdata/makefsdata.d 


# Each subdirectory must supply rules for building sources it contributes
rt-thread/components/net/lwip-2.0.2/src/apps/httpd/makefsdata/%.o: ../rt-thread/components/net/lwip-2.0.2/src/apps/httpd/makefsdata/%.c
