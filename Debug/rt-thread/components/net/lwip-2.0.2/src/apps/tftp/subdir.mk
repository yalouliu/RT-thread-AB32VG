...
C_SRCS += \
../rt-thread/components/net/lwip-2.0.2/src/apps/tftp/tftp_port.c \
../rt-thread/components/net/lwip-2.0.2/src/apps/tftp/tftp_server.c 

OBJS += \
./rt-thread/components/net/lwip-2.0.2/src/apps/tftp/tftp_port.o \
./rt-thread/components/net/lwip-2.0.2/src/apps/tftp/tftp_server.o 

C_DEPS += \
./rt-thread/components/net/lwip-2.0.2/src/apps/tftp/tftp_port.d \
./rt-thread/components/net/lwip-2.0.2/src/apps/tftp/tftp_server.d 


# Each subdirectory must supply rules for building sources it contributes
rt-thread/components/net/lwip-2.0.2/src/apps/tftp/%.o: ../rt-thread/components/net/lwip-2.0.2/src/apps/tftp/%.c
