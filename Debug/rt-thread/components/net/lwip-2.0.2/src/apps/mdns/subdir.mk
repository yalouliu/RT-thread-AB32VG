...
C_SRCS += \
../rt-thread/components/net/lwip-2.0.2/src/apps/mdns/mdns.c 

OBJS += \
./rt-thread/components/net/lwip-2.0.2/src/apps/mdns/mdns.o 

C_DEPS += \
./rt-thread/components/net/lwip-2.0.2/src/apps/mdns/mdns.d 


# Each subdirectory must supply rules for building sources it contributes
rt-thread/components/net/lwip-2.0.2/src/apps/mdns/%.o: ../rt-thread/components/net/lwip-2.0.2/src/apps/mdns/%.c
