...
C_SRCS += \
../rt-thread/components/net/lwip-2.0.2/src/apps/sntp/sntp.c 

OBJS += \
./rt-thread/components/net/lwip-2.0.2/src/apps/sntp/sntp.o 

C_DEPS += \
./rt-thread/components/net/lwip-2.0.2/src/apps/sntp/sntp.d 


# Each subdirectory must supply rules for building sources it contributes
rt-thread/components/net/lwip-2.0.2/src/apps/sntp/%.o: ../rt-thread/components/net/lwip-2.0.2/src/apps/sntp/%.c
