...
C_SRCS += \
../rt-thread/components/net/lwip-2.0.2/src/apps/mqtt/mqtt.c 

OBJS += \
./rt-thread/components/net/lwip-2.0.2/src/apps/mqtt/mqtt.o 

C_DEPS += \
./rt-thread/components/net/lwip-2.0.2/src/apps/mqtt/mqtt.d 


# Each subdirectory must supply rules for building sources it contributes
rt-thread/components/net/lwip-2.0.2/src/apps/mqtt/%.o: ../rt-thread/components/net/lwip-2.0.2/src/apps/mqtt/%.c
