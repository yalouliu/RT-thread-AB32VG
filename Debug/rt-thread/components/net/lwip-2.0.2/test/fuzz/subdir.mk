...
C_SRCS += \
../rt-thread/components/net/lwip-2.0.2/test/fuzz/fuzz.c 

OBJS += \
./rt-thread/components/net/lwip-2.0.2/test/fuzz/fuzz.o 

C_DEPS += \
./rt-thread/components/net/lwip-2.0.2/test/fuzz/fuzz.d 


# Each subdirectory must supply rules for building sources it contributes
rt-thread/components/net/lwip-2.0.2/test/fuzz/%.o: ../rt-thread/components/net/lwip-2.0.2/test/fuzz/%.c
