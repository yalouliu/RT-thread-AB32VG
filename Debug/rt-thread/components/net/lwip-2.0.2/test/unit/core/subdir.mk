...
C_SRCS += \
../rt-thread/components/net/lwip-2.0.2/test/unit/core/test_mem.c \
../rt-thread/components/net/lwip-2.0.2/test/unit/core/test_pbuf.c 

OBJS += \
./rt-thread/components/net/lwip-2.0.2/test/unit/core/test_mem.o \
./rt-thread/components/net/lwip-2.0.2/test/unit/core/test_pbuf.o 

C_DEPS += \
./rt-thread/components/net/lwip-2.0.2/test/unit/core/test_mem.d \
./rt-thread/components/net/lwip-2.0.2/test/unit/core/test_pbuf.d 


# Each subdirectory must supply rules for building sources it contributes
rt-thread/components/net/lwip-2.0.2/test/unit/core/%.o: ../rt-thread/components/net/lwip-2.0.2/test/unit/core/%.c
